...
- `packages/optio-api/src/__tests__/handlers.test.ts`:
  - Delete 8 "from pre-check: engine.X never called" tests (3 in launch describe, 3 in cancel describe, 2 in dismiss describe; line ranges around 168–198, 281–311, 394–412).
