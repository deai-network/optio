...
class EngineClient:
    ...
    async def block_launches(self, params: BlockLaunchesParams, *, timeout_ms: int | None = None) -> BlockLaunchesResult:
        raw = await self._client.call("engine", "blockLaunches", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
    ...
    async def cancel(self, params: CancelParams, *, timeout_ms: int | None = None) -> CancelResult:
        raw = await self._client.call("engine", "cancel", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
        return CancelResult.model_validate(raw)

    async def dismiss(self, params: DismissParams, *, timeout_ms: int | None = None) -> DismissResult:
        raw = await self._client.call("engine", "dismiss", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
    ...
    async def group_cancel(self, params: GroupCancelParams, *, timeout_ms: int | None = None) -> GroupCancelResult:
        raw = await self._client.call("engine", "groupCancel", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
    ...
    async def group_cancel_and_wait(self, params: GroupCancelAndWaitParams, *, timeout_ms: int | None = None) -> GroupCancelAndWaitResult:
        raw = await self._client.call("engine", "groupCancelAndWait", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
    ...
    async def launch(self, params: LaunchParams, *, timeout_ms: int | None = None) -> LaunchResult:
        raw = await self._client.call("engine", "launch", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
        return LaunchResult.model_validate(raw)

    async def resync(self, params: ResyncParams) -> None:
        await self._client.notify("engine", "resync", params.model_dump(mode='json', by_alias=True))

    async def unblock_launches(self, params: UnblockLaunchesParams, *, timeout_ms: int | None = None) -> UnblockLaunchesResult:
        raw = await self._client.call("engine", "unblockLaunches", params.model_dump(mode='json', by_alias=True), timeout_ms=timeout_ms)
