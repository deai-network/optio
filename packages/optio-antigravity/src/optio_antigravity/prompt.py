"""AGENTS.md composition for optio-antigravity: the profile, plus a thin
wrapper over the shared composer (``optio_agents.prompt.compose_instructions_file``),
...
PROFILE = AgentPromptProfile(
    ...
    state_dir_contents="Antigravity's own state store (the conversation transcript, artifacts, settings)",
)
...
def compose_agents_md(
    ...
    *,
    ...
    """Render <workdir>/AGENTS.md for an optio-antigravity task.
