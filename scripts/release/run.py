...
TS_PUBLISHABLE = ["filtrum-core", "filtrum-mongo", "optio-contracts", "optio-agents-ui", "optio-ui", "optio-api", "optio-conversation-ui", "optio-dashboard"]
PY_PUBLISHABLE = ["optio-core", "optio-host", "optio-agents", "optio-claudecode", "optio-grok", "optio-codex", "optio-cursor", "optio-kimicode", "optio-antigravity", "optio-opencode", "optio-agents-all", "optio-demo"]
