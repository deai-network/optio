import { ZodErrorSchema, TsRestResponseError, validateResponse, isAppRouteNoBody, isAppRouteOtherResponse, checkZodSchema, parseJsonQueryObject } from '@ts-rest/core';
import { z } from 'zod';
...
const validateRequest = (request, reply, schema, options) => {
    ...
    const queryResult = checkZodSchema(options.jsonQuery
        ? parseJsonQueryObject(request.query)
...
export { RequestValidationError, RequestValidationErrorSchema, initServer };
